export default {
    ...
    internetConnected: 'مجددا به اینترنت وصل شده‌اید.',
    internetError: 'خطا در اتصال به اینترنت.',
    ...
    errors: {
        ...
        '-12': 'تاریخ تولد با اطلاعات دارنده‌ی کارت اهدای عضو مطابقت ندارد.',
